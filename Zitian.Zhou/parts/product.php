  ...
  <div class="about">
    <article id="dig" >
      <h2><a name="about">PS5 Host (Digital Edition)</a></h2>
      <div class="aboutimg">
        <img src="img/ps5-780x470.jpeg" alt=""/>
      </div>
      <div class="abouttxt">
      ...
      <button type="button" class="button"> add to shopping cart </button>
    </article>
  </div>
  <div class="about">
    <article id="ps5">
    <h2><a name="about">PS5 Host </a></h2>
    <div class="aboutimg">
      <img src="img/shutterstoc.jpg" alt=""/>
    </div>
    <div class="abouttxt">

        <h3>Play Has No Limits™</h3>
      <br/>
      The official price : $399
      <br/>
      <br/>
  ...
  <div class="game">
    ...
    <div class="lists">
      <h2>PS5 game </h2>
      <div class="listimg">
        <img src="img/spider.webp.jpg" alt=""/>
        <div class="listp">
      ...
      <div class="listimg">
        <img src="img/7c739311d2e7964a1faf4e59ef0e0a12052127a6.jpg@1320w_742h.webp.jpg" alt=""/>
        <div class="listp">
          <h2>Demon's Souls</h2>
          <br/>
          Release date: November 12, 2020
          ...
          Introduction: This is a remake of an action role-playing game released on the PS3 in 2009.
          Dark Souls series and the Wolf and other mainstream "death games" of the originator.
          With a 4K/60fps feature mode and a 4K/30fps movie mode with improved graphics,
          players can choose their own mode to experience the action in the game.
        </div>
        <button type="button" class="button"> add to shopping cart </button>
      </div>
    </div>
